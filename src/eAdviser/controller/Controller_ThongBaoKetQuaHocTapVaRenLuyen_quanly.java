...
public class Controller_ThongBaoKetQuaHocTapVaRenLuyen_quanly extends ThongBaoKetQuaHocTapVaRenLuyen
		implements ZEController,ServletRequestAware,ServletResponseAware {

	ObjectDAO dao = new DAO_ThongBaoKetQuaHocTapVaRenLuyen();
	String timKiemTheo;
	String tuKhoa;
	String duongDanTrang = "eAdviser/pages/thongbaoketquahoctapvarenluyens_quanly.jsp";
	String duongDanTrangView = "eAdviser/pages/thongbaoketquahoctapvarenluyen_quanly.jsp";
	...
	public String exportData() throws IOException {
		...
		if (!getMaSinhVien().equals("all") && !getMaSinhVien().isEmpty())
			list_thongbao = dao_thongbao.listByColumnLike("sinhVien", getMaSinhVien());
		else
		...
		for (ThongBaoKetQuaHocTapVaRenLuyen thongbao : list_thongbao) {
			...
			cell = row.createCell(4, CellType.STRING);
			cell.setCellValue(thongbao.getSinhVien().getHoDem() + thongbao.getSinhVien().getTen());
