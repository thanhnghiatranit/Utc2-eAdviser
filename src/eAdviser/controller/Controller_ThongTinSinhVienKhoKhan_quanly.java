...
public class Controller_ThongTinSinhVienKhoKhan_quanly extends ThongTinSinhVienKhoKhan implements ZEController, ServletRequestAware,ServletResponseAware{

	ObjectDAO dao=new DAO_ThongTinSinhVienKhoKhan();
	
	String timKiemTheo;
	String tuKhoa;
	String duongDanTrang = "eAdviser/pages/thongtinsinhvienkhokhans_quanly.jsp";
	String duongDanTrangView = "eAdviser/pages/thongtinsinhvienkhokhan_quanly.jsp";
	...
	public String exportData() throws IOException {
		...
		if (!getMaSoCoVanHocTap().equals("all") && !getMaSoCoVanHocTap().isEmpty())
			list_thongtinsinhvienkhokhan = dao_thongtinsinhvienkhokhan.listByColumnLike("soCoVanHocTap", getMaSoCoVanHocTap());
		else
