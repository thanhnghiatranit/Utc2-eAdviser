...
public class Controller_BienBanSinhHoatLop extends BienBanSinhHoatLop implements ZEController, ServletRequestAware, ServletResponseAware{
	...
	public String exportData() throws IOException {
		...
		if (maSo!=null && !maSo.isEmpty()) {
			list_bienban = dao_bienban.listByColumnLike("soCoVanHocTap", maSo);
		}
		else
		{
