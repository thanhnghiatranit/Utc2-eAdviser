...
public class Controller_ThongTinSinhVien_quanly extends ThongTinSinhVien implements ZEController, ServletRequestAware,ServletResponseAware{

	ObjectDAO dao=new DAO_ThongTinSinhVien();
	
	String timKiemTheo;
	String tuKhoa;
	String duongDanTrang = "eAdviser/pages/thongtinsinhviens_quanly.jsp";
	String duongDanTrangView = "eAdviser/pages/thongtinsinhvien_quanly.jsp";
	...
	public String exportData() throws IOException {
		...
		if (!getMaSoCoVanHocTap().equals("all") && !getMaSoCoVanHocTap().isEmpty())
			list_thongtinsinhvien = dao_thongtinsinhvien.listByColumnLike("soCoVanHocTap", getMaSoCoVanHocTap());
		else
