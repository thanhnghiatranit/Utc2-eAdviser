...
public class Controller_BaoCaoTinhHinhLop extends BaoCaoTinhHinhLop implements ZEController, ServletRequestAware,ServletResponseAware {
	...
	public String exportData() throws IOException {
		...
		if (maSo!=null && !maSo.isEmpty()) {
			list_baocao = dao_baocao.listByColumnLike("soCoVanHocTap", maSo);
		}
		else
		{
