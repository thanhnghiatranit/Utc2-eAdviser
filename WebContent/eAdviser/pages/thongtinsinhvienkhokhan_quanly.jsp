								...
								<div class="form-group">
									...
									<option></option>
										<%
											...
											String maSo  = request.getParameter("maSoCoVanHocTap")!=null?request.getParameter("maSoCoVanHocTap"):"";
									...
									function chonSoCoVanHocTap() {
										var maSo = document.getElementById("maSoCoVanHocTap").value;
										window.location.href = "index.jsp?p=eAdviser/pages/thongtinsinhvienkhokhan_quanly.jsp&maSoCoVanHocTap="+maSo;
									}
									</script>
								</div>
								<div class="form-group">
						...
						: Util_Date.dateToString(new Date()))%>"
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="lyDo"
										<%=(modeView ? " disabled " : "")%>><%=(obj != null && obj.getLyDo() !=null ? obj.getLyDo() : "")%></textarea>
								</div>
								<div class="form-group">
									<label>Đề xuất</label>
									<textarea class="form-control" name="deXuat"
										<%=(modeView ? " disabled " : "")%>><%=(obj != null && obj.getDeXuat() !=null? obj.getDeXuat() : "")%></textarea>
								</div>
							</div>
						</div>
						<div class="row">
