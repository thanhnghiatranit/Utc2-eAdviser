				...
				<form class="form-inline pull-left">
					<label>Chọn lớp</label> <select name="maLop"
						...
						<%
							...
							ArrayList<ThongBaoKetQuaHocTapVaRenLuyen> list_thongbao = dao_thongbao.listAll();
						%>
						...
						%>
						<option value="<%=thongbao.getSoCoVanHocTap().getLop().getMaLop()%>"
							<%if (maLop.equals(thongbao.getSoCoVanHocTap().getLop().getMaLop())) {%>
							selected="selected" <%}%>><%=thongbao.getSoCoVanHocTap().getLop().getMaLop()%></option>
						<%
							}
						%>
					</select>
